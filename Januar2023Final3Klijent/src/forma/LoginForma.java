...
public class LoginForma extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        txtemail.setText("danilo@gmail.com");

        txtpass.setText("danilo");
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        Korisnik korisnik =  new Korisnik("", "", txtemail.getText(), String.valueOf(txtpass.getPassword()));
        ...
        if(odgovor.getParametar()==null){
            brojac--;
            JOptionPane.showMessageDialog(this, odgovor.getPoruka()+"Preostalo jos "+brojac+" pokusaja.");
        }else{
