...
public class LoginForma extends javax.swing.JFrame {
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        Urednik urednik =  new Urednik(txtUser.getText(), String.valueOf(txtPass.getPassword()));
        Komunikacija.getInstance().posaljiZahtev(new Zahtev(Operacija.LOGIN, urednik));
        ...
        if(odg.getParamtera()==null){
            ...
            GlavnaForma gf = new GlavnaForma(urednik);
            gf.setVisible(true);
