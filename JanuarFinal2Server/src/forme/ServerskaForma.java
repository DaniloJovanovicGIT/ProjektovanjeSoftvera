...
public class ServerskaForma extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jPanel1.setBorder(javax.swing.BorderFactory.createTitledBorder("Broj angazaovanja profesora"));
    ...
    public void popuniBrojAngaozvanja() {
        ArrayList<BrojAngazovanja> listaBrojAngazovanja = Kontroler.getInstance().vratiBrojAngazovanja();
        ModelTabeleBrojAngazovanja mtb = (ModelTabeleBrojAngazovanja) tblBrojAngazovanja.getModel();
        mtb.setLista(listaBrojAngazovanja);
    }

    public void popuniBrojProfesora() {
        ArrayList<BrojProfesora> listaBrojProfesora = Kontroler.getInstance().vratiBrojProfesora();
        ModelTabeleBrojProfesora mtp = (ModelTabeleBrojProfesora) tblBrojProfesora.getModel();
        mtp.setLista(listaBrojProfesora);
    }
}
